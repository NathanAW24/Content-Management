...
const index = () => {
  ...
  return (
    <LayoutMain menuKey="campaign">
      <div className="m-10">
        <LeftOutlined className="text-4xl my-5 hover:cursor-pointer" onClick={() => Router.push('/campaign')} />
        ...
        <MediaList videoData={assetList} isAssetPage={false} fetchInitialPayload={fetchGql} />
      </div>
    </LayoutMain>
  );
};
